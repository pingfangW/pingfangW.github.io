...
样本参数维度为$$d$$，样本数量维度是$$n$$。这里设定$$X$$的维度是$$n \times d$$，$$w$$的维度是$$d \times 1$$，$$Y$$的维度是$$n \times 1$$。
...
第二步：计算梯度 $$\nabla L(w) = \begin{pmatrix} \frac{\partial L(w)}{\partial w_0} & \cdots & \begin{pmatrix} \frac{\partial L(w)}{\partial w_d} \end{pmatrix}$$
